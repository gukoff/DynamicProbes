...
//     Sun, 15 Sep 2024 17:49:09 +02:00
//
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T1.ArgType, T2.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T1.ArgType, T2.ArgType, T3.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T1.ArgType, T2.ArgType, T3.ArgType, T4.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T1.ArgType, T2.ArgType, T3.ArgType, T4.ArgType, T5.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, T1.ArgType, T2.ArgType, T3.ArgType, T4.ArgType, T5.ArgType, T6.ArgType));
    }
}
