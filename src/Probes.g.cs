...
//     Sun, 15 Sep 2024 20:09:19 +02:00
//
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T1.ArgType, (Libstapsdt.ArgType)T2.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T1.ArgType, (Libstapsdt.ArgType)T2.ArgType, (Libstapsdt.ArgType)T3.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T1.ArgType, (Libstapsdt.ArgType)T2.ArgType, (Libstapsdt.ArgType)T3.ArgType, (Libstapsdt.ArgType)T4.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T1.ArgType, (Libstapsdt.ArgType)T2.ArgType, (Libstapsdt.ArgType)T3.ArgType, (Libstapsdt.ArgType)T4.ArgType, (Libstapsdt.ArgType)T5.ArgType));
    }
}
...
partial class Provider
{
    ...
    {
        var @this = This;
        return new(@this, name, Libstapsdt.Libstapsdt.ProviderAddProbe(@this.ptr, name, (Libstapsdt.ArgType)T1.ArgType, (Libstapsdt.ArgType)T2.ArgType, (Libstapsdt.ArgType)T3.ArgType, (Libstapsdt.ArgType)T4.ArgType, (Libstapsdt.ArgType)T5.ArgType, (Libstapsdt.ArgType)T6.ArgType));
    }
}
